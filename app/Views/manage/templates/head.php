      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo mb-4">
            <a href="/manage/dashboard" class="app-brand-link">
              <a class="navbar-brand" href="/">
                <img src="/assets/imgs/logo3.png?v=2" style="width:130px">
                <div class="mt-2 ps-1"><b>For Managers</b></div>
              </a>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Managers</div>
              </a>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="pages-account-settings-account.html" class="menu-link">
                    <div data-i18n="Account">Analysis</div>
                  </a>
                </li>
                <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Authentications">Reviews</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Misc">Promotions</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
            ...
            <!-- Misc -->
            <li class="menu-header small text-uppercase"><span class="menu-header-text">Guide</span></li>
            <li class="menu-item">
              <a
